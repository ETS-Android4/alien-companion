...
public class AppConstants {
    ...
    public static final String CURRENT_VERSION_NAME = "1.0.9";

    public static final int CURRENT_VERSION_CODE = 1009;
    ...
    public static final long TOTAL_CACHE_LIMIT = 90 * 1024 * 1024;
